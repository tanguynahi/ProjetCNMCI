...
class StoreActualiteRequest extends FormRequest
{
    ...
    {
        return [
            'lien_photo' => 'required|image|mimes:jpg,jpeg,png',
            'libelle' => 'required|string|min:3|unique:actualites,libelle',
    ...
    public function messages(): array
    {
        return [
            ...
            'libelle.min' => 'Le libellé de l\'actualité doit contenir au moins 3 caractères.',
            'libelle.unique' => 'Cette actualité existe déjà dans notre système.',
