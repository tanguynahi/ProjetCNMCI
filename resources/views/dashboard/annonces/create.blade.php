@extends('layouts.dashboard', ['title' => 'Ajouter une Annonce'])
@push('css')
@endpush
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Annonces /</span> Ajouter
        </h4>
        <div class="row">
            <!-- FormValidation -->
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header">Formulaire Ajouter Une Annonce</h5>
                    <div class="card-body">
                        <form action="{{ route('annonces.store') }}" method="POST" id="add_imageSlide_form"
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-floating" >
                                        <input type="categorie" id="categorie" name="categorie"
                                            ...
                                            value="Image Annonce"
                                            {{ old('categorie') == 'Image Annonce' ? 'selected' : '' }}
                                            placeholder="Sous-titre de l'image" autocomplete="categorie" autofocus readonly>
                                        @error('categorie')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
