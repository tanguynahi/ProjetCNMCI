@extends('layouts.dashboard', ['title' => 'Images - Liste des Annonces'])
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6">
                            <h5 class="card-title mb-0">Liste des Images Annonces</h5>
                        </div>
                        <div class="col-6">
                    ...
                    <table class="table align-middle table-nowrap" id="myTable">
                        ...
                        <tbody>
                            @foreach ($annonces as $index => $annonce)
                                @php
                                $imgUrl = $annonce->lien_image ? asset($annonce->lien_image) : asset('assets/dashboard/img/default-img.png');
                                    $statusBadge =
                                        $annonce->status == 1
                                ...
                                <tr>
                                    ...
                                    <td>{{ $annonce->titre }}</td>
                                    <td style="white-space: pre-line;">{!! couperTexte2($annonce->sous_titre, 20) !!}</td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#deleteModal{{ $annonce->id }}" id="DeleteIdentification"
                                                class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill"
                                ...
                                <!-- Modal delete-->
                                <div class="modal fade flip" id="deleteModal{{ $annonce->id }}" tabindex="-1"
                                    aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body p-5 text-center">
                                                ...
                                                <div class="mt-4 text-center">
                                                    <h4>Vous êtes sur le point de supprimer <br>une Annonce ?</h4>
                                                    <p class="text-muted fs-15 mb-4">En supprimant cette Annonce,
                                                        vous
                                                        supprimez
                                                    ...
                                                    <div class="hstack gap-2 justify-content-center remove">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('annonces.destroy', $annonce->id) }}">
                                                            @csrf
                                                            @method('DELETE')
