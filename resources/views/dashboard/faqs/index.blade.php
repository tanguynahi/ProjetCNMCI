@extends('layouts.dashboard', ['title' => 'Question(s) favorite(s) - Liste des FAQ'])
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6">
                            <h5 class="card-title mb-0">Liste des FAQ(s)</h5>
                        </div>
                        <div class="col-6">
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('faqs.create') }}" class="btn btn-primary">Ajouter des FAQ</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($faqs as $index => $faq)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $faq->libelle }}</td>
                                    <td style="white-space: pre-line;">{!! couperTexte2($faq->description, 20) !!}</td>
                                    <td>{!! $statusBadge !!}</td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#deleteModal{{ $faq->id }}" id="DeleteIdentification"
                                                class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill"
                                ...
                                <!-- Modal delete-->
                                <div class="modal fade flip" id="deleteModal{{ $faq->id }}" tabindex="-1"
                                    aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body p-5 text-center">
                                                ...
                                                <div class="mt-4 text-center">
                                                    <h4>Vous êtes sur le point de supprimer <br>la Question ?</h4>
                                                    <p class="text-muted fs-15 mb-4">En supprimant cette question,
                                                        vous
                                                        supprimez
