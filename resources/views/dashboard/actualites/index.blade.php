@extends('layouts.dashboard', ['title' => 'Actualites - Liste des Actualites'])
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('actualites.create') }}" class="btn btn-primary">Ajouter</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table align-middle table-nowrap" id="myTable">
                        ...
                        <tbody>
                            ...
                            @foreach ($actualites as $index => $actualite)
                                @php
                                    $imgUrl = $actualite->lien_photo
                                        ? asset($actualite->lien_photo)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#deleteModal{{ $actualite->id }}" id="DeleteIdentification"
                                                class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body p-5 text-center">
                                                ...
                                                <div class="mt-4 text-center">
                                                    ...
                                                    <p class="text-muted fs-15 mb-4">En supprimant cette actualité,
                                                        vous
                                                        supprimez
