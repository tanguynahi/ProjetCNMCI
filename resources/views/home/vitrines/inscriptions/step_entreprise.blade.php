    ...
    <div class="row" hidden>
        <center>
            <div class="col-md-6 col-lg-6 col-12 mb-4 ">
                <label class="form-label bold">N° D'Identification
    ...
    <div class="row mt-6">
        ...
        <div class="col-md-3 col-lg-3 col-12">
            ...
            <input type="text" name="denomination_entreprise"
                ...
                value="{{ old('denomination_entreprise') }}">
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-6 col-lg-6 col-12">
            <input type="text" name="numero_registre"
                ...
                autocomplete="numero_registre" autofocus value="{{ old('numero_registre') }}" required>
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-3 col-lg-3 col-12">
            ...
            <input type="text" name="sigle_ou_enseigne"
                ...
                autocomplete="sigle_ou_enseigne" autofocus value="{{ old('sigle_ou_enseigne') }}" required>
        ...
        <div class="col-md-3 col-lg-3 col-12">
            ...
            <input type="text" name="objet_social"
                ...
                autocomplete="objet_social" autofocus value="{{ old('objet_social') }}" required>
            @error('objet_social')
                <span class="invalid-feedback" role="alert">
                    <strong>
                        {{ $message }}
    ...
    <div class="row mt-4">
        <div class="col-md-3 col-lg-3 col-12">
            ...
            <input type="number" name="nombre_associes"
                ...
                value="{{ old('nombre_associes') }}" required>
        ...
        <div class="col-md-3 col-lg-3 col-12">
            ...
            <div class="input-group">
                <input type="number" name="duree_personne_morale"
                    ...
                    value="{{ old('duree_personne_morale') }}" required>
                <div>
        ...
        <div class="col-md-3 col-lg-3 col-12">
            ...
            <input type="text" name="numero_compte_contribuable"
                ...
                value="{{ old('numero_compte_contribuable') }}" required>
