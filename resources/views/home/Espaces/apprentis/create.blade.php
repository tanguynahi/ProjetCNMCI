@extends('layouts.espace_home_layouts', ['title' => "Creation d'un apprentis"])
@push('css')
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            ...
            <span class="text-muted fw-light">Apprentis /</span> Enregistrement
        </h4>
        <div class="row">
            <div class="col-md-12">

                <div class="card mb-4">
                    <h5 class="card-header">Formulaire d'enregistrement d'un apprentis</h5>
                    <!-- Account -->
                    <hr class="my-0">
                    <div class="card-body">
                        <form id="formAccountSettings" method="Post" action="#">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-4 col-lg-4 col-12">
                                        <label for="date_debut_apprentissage"
                                            class="form-label">date_debut_apprentissage</label>
                                        <input
                                            class="form-control @error('date_debut_apprentissage') is-invalid @enderror"
                                            type="text" id="date_debut_apprentissage"
                                            placeholder="date_debut_apprentissage" name="date_debut_apprentissage"
                                            value="{{ old('date_debut_apprentissage') }}" />
                                        @error('date_debut_apprentissage')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-4 col-lg-4 col-12">
                                        <label for="date_debut_apprentissage_entreprise"
                                            class="form-label">date_debut_apprentissage en entreprise</label>
                                        <input
                                            class="form-control @error('date_debut_apprentissage_entreprise') is-invalid @enderror"
                                            type="text" id="date_debut_apprentissage_entreprise"
                                            placeholder="date_debut_apprentissage_entreprise"
                                            name="date_debut_apprentissage_entreprise"
                                            value="{{ old('date_debut_apprentissage_entreprise') }}" />
                                        @error('date_debut_apprentissage_entreprise')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
