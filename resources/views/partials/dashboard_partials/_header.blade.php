<nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <div class="navbar-nav align-items-center">
            <span class="fs-3 text-danger fw-bold">TABLEAU DE BORD - CNMCI</span>
        </div>
        <!-- /Search -->
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-styles">
                    <li>
                        <a class="dropdown-item" href="javascript:void(0);" data-theme="light">
                            <span class="align-middle"><i class='ti ti-sun me-2'></i>Thème Claire</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="javascript:void(0);" data-theme="dark">
                            <span class="align-middle"><i class="ti ti-moon me-2"></i>Thème Sombre</span>
                        </a>
                    </li>
                    <li>
                ...
                <div class="dropdown-menu dropdown-menu-end py-0">
                    <div class="dropdown-menu-header border-bottom">
                        <div class="dropdown-header d-flex align-items-center py-3">
                            <h5 class="text-body mb-0 me-auto">Configurations</h5>
                    ...
                    <div class="dropdown-shortcuts-list scrollable-container">
                        ...
                        <div class="row row-bordered overflow-visible g-0">
                            ...
                            <div class="dropdown-shortcuts-item col">
                                ...
                                <a href="app-access-roles.html" class="stretched-link">Gestion des rôles</a>
                                <small class="text-muted mb-0">Permissions</small>
                            </div>
                        </div>
                        <div class="row row-bordered overflow-visible g-0">
                            <div class="dropdown-shortcuts-item col">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/dashboard/img/avatars/2.png') }}"
                                                alt="Photo de profil" class="h-auto rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/dashboard/img/avatars/9.png') }}"
                                                alt="Photo de profil" class="h-auto rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/dashboard/img/avatars/5.png') }}"
                                                alt="Photo de profil" class="h-auto rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/dashboard/img/avatars/6.png') }}"
                                                alt="Photo de profil" class="h-auto rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
