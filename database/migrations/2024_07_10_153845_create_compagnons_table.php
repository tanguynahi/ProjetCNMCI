...
return new class extends Migration
{
    ...
    {
        Schema::create('compagnons', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('date_debut_compagnonnage');
            $table->date('date_debut_compagnonnage_entreprise');
    ...
    {
        Schema::dropIfExists('compagnons');
    }
};
